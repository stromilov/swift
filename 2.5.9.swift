...
if let number = readLine() {
    print("Цифра в позиции тысяч равна \(Int(number)! / 1000)")
    print("Цифра в позиции сотен равна \(Int(number)! % 1000 / 100)")
    print("Цифра в позиции десятков равна \(Int(number)! % 1000 % 100 / 10)")
    print("Цифра в позиции единиц равна  \(Int(number)! % 1000 % 100 % 10)")
}